...
namespace SelfSign
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            X509Certificate2 cert = GenerateSelfSignedCertificate("CN=127.0.01", "CN=MYTESTCA", myCAprivateKey);
            byte[] pfx = cert.Export(X509ContentType.Pfx);
            var pfxCert = new X509Certificate2(pfx, (string)null, X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.MachineKeySet);
            addCertToStore(pfxCert, StoreName.My, StoreLocation.LocalMachine);
        }
